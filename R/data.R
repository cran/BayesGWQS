...
#'
#' Data were simulated to have 0.7 in-group correlation and 0.3 between-group correlation. There are three groups,
#' with the third being significantly correlated to the outcome variable.
#'
#'
